...
export declare class HereWallet implements HereWalletProtocol {
    ...
    signIn({ contractId, allowance, methodNames, selector, ...delegate }?: SignInOptions): Promise<string>;
    ...
    legacySignMessage({ message, receiver, nonce, selector, ...delegate }: SignMessageOptionsLegacy & HereAsyncOptions): Promise<SignMessageLegacyReturn>;
    signAndSendTransactions({ transactions, selector, ...delegate }: SignAndSendTransactionsOptions): Promise<FinalExecutionOutcome[]>;
}
